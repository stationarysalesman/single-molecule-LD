function [xs, ys] = simulate_noise_levels()
...
for i = 1:length(xs)
   ...
   for j = 1:num_sims
       [tmp_real(j), tmp_computed(j)] = simulate_rotating_waveplate_signal(motor_freq, exposure_time, num_frames, amplitude, offset, xs(i), sample_limit);
   end
